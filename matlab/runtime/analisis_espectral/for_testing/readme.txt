analisis_espectral MATLAB Python Package
...
2. Installing the analisis_espectral Package

A. Change to the directory that contains the file setup.py and the subdirectory 
analisis_espectral. If you do not have write permissions, copy all its contents to a 
...
3. Using the analisis_espectral Package

The analisis_espectral package is on your Python path. To import it into a Python script 
or session, execute:
